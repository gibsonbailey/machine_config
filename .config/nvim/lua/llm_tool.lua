...
local options = {
    {
        ...
        action = function()
            ...
            if input and #input > 0 then
                ...
                vim.api.nvim_buf_set_text(0, start_row, start_col, end_row,
                                          end_col, {input})
            else
        ...
        action = function() print("Executing a command...") end
    }, {
        label = "Option 3: Open a file",
        action = function() vim.cmd("edit newfile.txt") end
    }, {
        label = "Option 4: Display a message",
        action = function() print("Hello from LLM Tool!") end
    }
}
